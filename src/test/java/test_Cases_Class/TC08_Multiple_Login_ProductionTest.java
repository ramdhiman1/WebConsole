...
public class TC08_Multiple_Login_ProductionTest extends Base_Page {
	...
	public void loginWithSecondUser() throws InterruptedException, IOException {
	...
	public void loginWithThirdUser() throws InterruptedException, IOException {
		...
		// Now Switch to Computers Page
		driver.get().get(p.getProperty("www3computerspage"));
		iw.SearchMachine();
		iw.selectOnlineWorkstation();
		iw.SearchMachine();
		iw.printAllProductStatuses();
